...
// Mock implementation of cleanSummaryText for testing
...
const testCases = [
    ...
    { input: "Summaryof everything...", expected: "Summaryof everything..." }, // Should NOT strip because it's part of a word
    { input: "Dependable summary...", expected: "Dependable summary..." } // Should NOT strip from middle
];
